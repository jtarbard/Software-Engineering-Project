...
class Booking(SqlAlchemyBase):
    ...
    receipt = orm.relationship("Receipt", back_populates="bookings")
...
class Subscription(SqlAlchemyBase):
    ...
    receipt = orm.relationship("Receipt", back_populates="subscriptions")
...
class Membership(SqlAlchemyBase):
    ...
    receipt = orm.relationship("Receipt", back_populates="memberships")
    membership_type = orm.relationship("MembershipType", back_populates="memberships")
